...
CreateSmeltingStoneExt()
{
    ...
    SetDynamicObjectMaterialText(smltxst, 0, "Smelter", 100, "Arial", 40, 1, 0xFFFFFFFF, 0x00000000, 1);
    ...
    SetDynamicObjectMaterialText(smltxst, 0, "Smelter", 90, "Arial", 30, 1, 0xFFFFFFFF, 0x00000000, 1);
